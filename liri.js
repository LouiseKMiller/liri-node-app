...
function twitterRequest(localParam){
	// call Twitter API using npm twitter; display results in terminal
	client.get('statuses/user_timeline', localParam, function(err, tweets, response){
		if (!err){
...
function spotifyRequest(localParam){
	trackName = "track:" + localParam;		
...
function movieRequest(name){


	// define queryURL for movie search
	// include rotton tomatoes info
	var queryURL = "http://www.omdbapi.com/?t=" + name + "&y=&plot=short&r=json&tomatoes=true&type=movie";
